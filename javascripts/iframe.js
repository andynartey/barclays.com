...
$(document).ready(function () {
    ...
    if (typeof (_iframeURL) != "undefined") {
        ...
        var iframe = $('<iframe " src="' + src + '" width="100%" height="' + _iframeURLHeight + '" frameborder="0" allowtransparency="true" marginheight="0" marginwidth="0"><\/iframe>').appendTo('#iframe');

        //var iframe = $("#ExternalWebContentExternalIFrame");
        ...
        $.receiveMessage(function (e) {
            ...
            if (!isNaN(h) && h > 0 && h !== if_height) {
                ...
                if ($('.contentright-full').length > 0) {
                    $('.contentright-full').height('auto');
                    setEqualHeight_great($('#leftnavigation>ul'), $('.contentright-full'), 768);
                }
