...
$(function(){
    ...
    BAR.StorytellerView = function(selector) {
        ...
        if ( this.storyTellerContainer.length >  0 ) {
            this.init();
        }
    }
    ...
    BAR.StorytellerView.prototype = {
        ...
        checkView: function(toggle) {
            ...
            if ( this.storyTellerBody.hasClass('storyteller-list-view') ) {
                ...
                this.storyItem.removeClass('clear-me');
                this.storyItem.removeClass('no-min-height');
            }
        }
    }
    ...
    BAR.StoryTellerFilter.prototype = {
        ...
        addSelectedItem: function(selectedItem) {
            ...
            var storyTellerFilter = this,
                ...
                dataItem = $(selectedItem).attr('data-storyteller-filter-item'),
                labelHolder = '<div class="storyteller-filter-label" data-storyteller-filter-item="'+dataItem+'"><a href="" title="'+txt+'" role="button"><span class="visuallyhidden">Clear current filter:</span>'+ txt + '</a></div>',
            ...
            if ( typeof getLinkPos !== 'undefined' ) {
        ...
        removeSelectedItem: function(self) {
            ...
            /*
            var identifierText = this.storyTellerContainer.html(),
                i = identifierText.indexOf("parentFilters"),
                identifier1 = identifierText.substring(i + 13, i + 49),
                functionName = "removeFilter"+ identifier1;

            if (typeof(window[functionName]) === "function") {
                window[functionName]($(self));
            } else {
                throw("Error.  Function " + functionName + " does not exist.");
            }*/
